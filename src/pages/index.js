...
const PageLink = ({ title, subtitle, to }) => (
  <Link className="group max-w-max" to={to}>
    ...
    <p className="flex items-center space-x-2 text-lg md:text-xl xl:text-2xl 2xl:text-3xl">
      <span>{subtitle}</span>
...
const IndexPage = () => (
  <Layout>
    ...
    <div className="h-full flex flex-col space-y-8 lg:space-y-10 xl:space-y-12 2xl:space-y-14">
      <h1 className="font-bold text-5xl md:text-7xl xl:text-8xl mt-4 md:mt-8">
        Hi, I'm Hamza
      </h1>
